		...
		<div class="card shadow-none border border-300 my-4"
			...
			<div class="card-body p-0">
				<div class="p-4 code-to-copy">
					...
					<form id="check"
						action="/photo/update?${_csrf.parameterName}=${_csrf.token}"
						method="post" enctype="multipart/form-data">
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label" for="ptitle">제목</label>
							<div class="col-sm-10">
								<input class="form-control" value="${photo.ptitle}" id="ptitle"
									name="ptitle" type="text" placeholder="제목을 입력하세요" required />
							</div>
						</div>
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label" for="pwriter">작성자</label>
							<div class="col-sm-10">
								<input class="form-control" id="pwriter" name="pwriter"
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<textarea class="form-control" id="summernote" name="pcontent"
									placeholder="제목을 입력하세요">${photo.pcontent} </textarea>
							</div>
						</div>
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label" for="pimage">첨부사진</label>
							<div class="col-sm-10">
								<input class="form-control" id="pimage" name="pimage"
									type="file" /> <br>※ 개별 이미지의 파일 사이즈는 1Mbyte를 초과할 수 없습니다.
							</div>
						</div>
						<br>
						<br> <input type="hidden" name="pno" value="${photo.pno}" />
						<input type="hidden" name="pimage" value="${photo.pimage}" />
