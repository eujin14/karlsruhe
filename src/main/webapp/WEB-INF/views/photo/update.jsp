...
<br><br>
   ...
   <form id="check" action="/photo/update?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
       <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="ptitle">제목</label>
                            <div class="col-sm-10">
                                <input class="form-control" value="${photo.ptitle}" id="ptitle" name="ptitle" type="text" placeholder="제목을 입력하세요" required />
                            </div>
                        </div>
                         <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="summernote" name="pcontent" placeholder="제목을 입력하세요" >${photo.pcontent} </textarea>
                            </div>
                        </div>
                         <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="pimage">첨부사진</label>
                            <div class="col-sm-10">
                                <input  class="form-control"  value="${photo.pcontent} " id="bimage" name="bimage" type="file"  required />
