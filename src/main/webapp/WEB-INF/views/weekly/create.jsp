            ...
            <form action="/weekly/create?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="gtitle" id= "gtitle" class="form-control" placeholder="제목을 입력해주세요" required>
                </div>
              ...
              <div class="form-group mt-3">
                 <textarea class="form-control" id="summernote" name="gcontent"></textarea>
              </div>
              <div class="form-group mt-3">
