			...
			<div class="row">
				...
				<div class="col-lg-11 entries">
					...
					<article class="entry entry-single">
						...
						<div class="container">
							<h2 class="entry-title">${board.btitle}</h2>
							<div class="entry-meta">
								<ul>
									<li class="d-flex align-items-center"><i
										class="bi bi-person"></i>${board.bwriter}</li>
									<li class="d-flex align-items-center"><i
										class="bi bi-clock"></i>${board.bdate}</li>
									<li class="d-flex align-items-center"><i
										class="bi bi-chat-dots"></i>댓글 ${replyListsSize}</li>
								</ul>
							</div>
							<br>
