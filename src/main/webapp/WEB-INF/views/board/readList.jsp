			...
			<div class="card-body p-0">
				<div class="p-4 code-to-copy">
					<div id="tableExample3"
						data-list='{"valueNames":["bno","btitle","bdate"],"page":5,"pagination":true,"filter":{"key":"btitle"}}'>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th class="sort border-top text-center text-end pe-3"
											scope="col" data-sort="bdate">작성일</th>
									</tr>
								</thead>
								<tbody class="list" id="table-regions-by-revenue">
									<c:forEach items="${boards}" var="board" varStatus="i">
										<tr>
											...
											<td class="align-middle text-center btitle"><a
